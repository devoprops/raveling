...
from src.api import auth, items, skills, characters, approval, users, effectors, weapons, effect_styles, collaboration, spells
...
app.include_router(effect_styles.router, prefix="/api/effect-styles", tags=["effect-styles"])
