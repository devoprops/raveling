"""Regen effect style for regenerative effects."""
...
class RegenEffectStyle(EffectStyle):
    """
    Regen effect style for regenerative/healing effects.
    
    Regen styles use RegenerativeEffector instances.
    """
    ...
    def __init__(
        ...
        """
        Initialize a regen effect style.
        
        Args:
            name: Style name (e.g., "Heal", "Mana Restore")
            subtype: Subtype identifier
            effector: RegenerativeEffector instance
        ...
        super().__init__(
            name=name,
            style_type=self.STYLE_TYPE_REGEN,
            subtype=subtype,
            effector=effector,
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any]) -> 'RegenEffectStyle':
        """Create style from configuration dictionary."""
        from src.models.effectors import RegenerativeEffector
        ...
        effector = RegenerativeEffector.from_config(effector_config)
