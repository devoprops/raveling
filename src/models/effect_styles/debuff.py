"""Debuff effect style for debuff effects."""
...
class DebuffEffectStyle(EffectStyle):
    """
    Debuff effect style for debuff effects.
    
    Debuff styles use DebuffEffector instances.
    """
    ...
    def __init__(
        ...
        """
        Initialize a debuff effect style.
        
        Args:
            name: Style name (e.g., "Weakness")
            subtype: Subtype identifier
            effector: DebuffEffector instance
        ...
        super().__init__(
            name=name,
            style_type=self.STYLE_TYPE_DEBUFF,
            subtype=subtype,
            effector=effector,
    ...
    @classmethod
    def from_config(cls, config: Dict[str, Any]) -> 'DebuffEffectStyle':
        """Create style from configuration dictionary."""
        from src.models.effectors import DebuffEffector
        ...
        effector = DebuffEffector.from_config(effector_config)
