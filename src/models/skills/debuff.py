...
from src.utils.constants import SKILL_TYPE_DEBUFF


class Debuff(Skill):
    """
    Debuff skill that decreases stats, resistance, or other attributes.
    
    Attributes:
        stat_modifiers: Dictionary mapping stat names to modifier values (negative)
        base_duration: Base duration of the debuff in turns
    ...
    def __init__(
        ...
        Args:
            ...
            stat_modifiers: Dictionary of stat name -> modifier value (typically negative)
    ...
    def calculate_duration(self, character: Any) -> int:
        """
        Calculate the duration of the debuff based on character stats.
    ...
    def apply_effect(self, character: Any) -> Dict[str, Any]:
        """
        Apply the debuff effect to a character.
        
        Args:
            character: Character to apply debuff to
